		...
		<div class="big-block">
			...
			<div class="green-box">
				...
				<p style="font-size:14px">Fler sätt att delta:<br />
				  <ul><li>Betygsätt ytterligare en plats och <a href="../reports/submit">föreslå förbättringar</a></li>
                   ...
                   <ul><li>Dela den här på <span class='st_facebook_button' displayText='Facebook'></span> eller  <span class='st_twitter_button' displayText='Tweet' st_url="<?php echo urlencode(url::base() . url::current()) ?>" st_title="Hjälp oss hitta kvaliteter och brister i centrala Lidingö. #lidingocentrumtorsvik"></span> för att få dina vänner att tycka till om staden.</li>
