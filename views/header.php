...
<meta property="og:title" content="Participatory Budgeting in NYC Online - Real Money. Real Projects. Real Power." />
<meta property="og:type" content="website" />
<?php if (!isset($og_description) OR !$og_description): ?>
<?php $og_description = "Add your project ideas now!"; ?>
<?php endif; ?>
  ...
  fjs.parentNode.insertBefore(js, fjs);
	...
	<div class="rapidxwpr floatholder">
		...
		<div id="header">
			...
			<!-- searchbox -->
			<div id="searchbox">
           <span class='st_twitter_button' displayText='Tweet' st_url="http://pps.org/placemap/pbnyc/reports/submit" st_title="Participatory Budgeting in NYC Online. Add your project ideas now! #pbnyc"></span><span class='st_email_button' displayText='Email'></span><span class='st_facebook_button' displayText='Facebook'></span><span class='st_sharethis_button' displayText='ShareThis'></span><br />
           <iframe src="//www.facebook.com/plugins/like.php?href=http%3A%2F%2Fpps.org%2Fplacemap%2Fpbnyc%2F&amp;send=false&amp;layout=box_count&amp;width=450&amp;show_faces=false&amp;action=like&amp;colorscheme=light&amp;font&amp;height=90" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:50px; height:90px; padding-top:30px" allowTransparency="true"></iframe>
				<!-- languages -->
   <?php // echo $languages;?>
				<!-- / languages -->
		...
		<div id="middle">
			<div class="background layoutleft">
				...
				<div id="mainmenu" class="clearingfix">
					<ul><h1><?php nav::main_tabs($this_page); ?><li><a href="http://pbnyc.org">PBNYC Home</a></li></h1></ul>
