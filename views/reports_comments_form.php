...
<div class="comment-block">
	...
	<h5><?php echo Kohana::lang('ui_main.leave_a_comment');?><br /><span style="display: none" class="subtext"><?php echo Kohana::lang('ui_main.leave_a_comment_subtext');?></span></h5>
	<?php
		if ($form_error) {
	?>
	<!-- red-box -->
	...
	?>
	<div class="report_row">
   <input name="submit" type="submit" value="<?php echo Kohana::lang(/*'ui_main.post_comment'*/ 'ui_main.comment'); ?>" class="btn_blue" />
	</div>
