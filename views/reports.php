...
<input type="submit" value="Apply" />
			...
			<div class="reports-box">
				...
				<?php
				foreach ($report_listing_view->incidents as $incident)
				{
					...
					else
					{
						$incident_verified = '<span class="r_unverified" style="display:none;">'.Kohana::lang('ui_main.unverified').'</span>';
                                        ...
                                        $comment_count = ORM::factory('comment')->where('incident_id', $incident_id)->find_all()->count();
						...
						<div class="r_media">
							...
							<div class="r_categories">
								...
								<?php
                                        ...
                                        $categories = $db->query('SELECT c.id, c.category_title, c.category_image_thumb, c.category_color FROM category c ' .
								...
								foreach ($categories AS $category)
								{
									...
									{
										?>
										<a class="r_category" href="<?php echo url::site(); ?>reports/?c=<?php echo $category->id; ?>"><span class="r_cat-box"><img src="<?php echo url::base().Kohana::config('upload.relative_directory')."/".$category->category_image_thumb; ?>" height="16" width="16" /></span>
<span class="r_cat-desc">
<?php //echo $localized_categories[(string)$category->category_title];?>
<?php echo $category->category_title; ?>
									...
									{
										?>
										<a class="r_category" href="<?php echo url::site(); ?>reports/?c=<?php echo $category->id; ?>"><span class="r_cat-box" style="background-color:#<?php echo $category->category_color;?>;"></span>
<span class="r_cat-desc">
<?php //echo $localized_categories[(string)$category->category_title];?>
<?php echo $category->category_title; ?>
</span></a>
...
<?php } ?>
			...
			<?php echo $report_listing_view->pagination; ?>
		</div>
		<!-- end reports block -->
	</div>
</div>
