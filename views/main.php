	...
	<?php } ?>
		...
		<div id="right" class="clearingfix">
			...
			<div class="cat-filters clearingfix">
				<strong style="display:none;"><?php echo Kohana::lang('ui_main.category_filter');?> <span>[<a href="javascript:toggleLayer('category_switch_link', 'category_switch')" id="category_switch_link"><?php echo Kohana::lang('ui_main.hide'); ?></a>]</span></strong>
			</div>
			...
			<div class="floatbox">
				...
				<div class="filters clearingfix">
					<div style="float:left; width: 100%">
						<strong style="display:none;"><?php echo Kohana::lang('ui_main.filters'); ?></strong>
